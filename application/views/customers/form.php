      ...
      <div class="modal-body">
				...
				<fieldset id="customer_basic_info">
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							<?php echo form_label($this->lang->line('customers_company_name').':', 'company_name',array('class'=>'col-sm-4')); ?>
							<div class='col-sm-8'>
								<?php echo form_input(array(
									'name'=>'company_name',
						...
						<div class="form-group">
							<?php echo form_label($this->lang->line('customers_account_number').':', 'account_number',array('class'=>'col-sm-4')); ?>
							<div class='col-sm-8'>
								<?php echo form_input(array(
									'name'=>'account_number',
									'id'=>'account_number',
						...
						<div class="form-group">
							<?php echo form_label($this->lang->line('customers_taxable').':', 'taxable',array('class'=>'col-sm-4')); ?>
							<div class='col-sm-2'>
