...
class Raw_materials extends Secure_area implements iData_controller
{
	function __construct()
	{
		parent::__construct('raw_materials');
	...
	function index($limit_from=0)
	{
		...
		$data['manage_table'] = get_raw_materials_manage_table( $this->Raw_material->get_all($stock_location, $lines_per_page, $limit_from), $this );
		$data['am'] = 'items';
		$data['asm_1'] = 'raw_materials';
		
		$this->load->view('raw_materials/manage', $data);
	...
	*/
	...
	function view($item_id=-1)
	{
		...
		$this->load->view("raw_materials/form", $data);
	}
