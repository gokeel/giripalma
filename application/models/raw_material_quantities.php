...
class Raw_material_quantities extends CI_Model
{
    ...
    {
        $this->db->from('raw_material_quantities');
    ...
    function save($location_detail, $item_id, $location_id)
    {
        ...
        {
            if($this->db->insert('raw_material_quantities',$location_detail))
            {
                return true;
            }
            return false;
        ...
        $this->db->where('item_id', $item_id);
        $this->db->where('location_id', $location_id);
        return $this->db->update('raw_material_quantities',$location_detail);
    }
    ...
    {     
        ...
        if(empty($result) == true)
        {
            ...
            $fields = $this->db->list_fields('raw_material_quantities');
